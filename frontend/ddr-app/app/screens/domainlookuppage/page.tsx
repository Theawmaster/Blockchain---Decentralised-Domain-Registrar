...
export default function domainlookuppage() {
  ...
  const [query, setQuery] = useState(""); // user input domain
  const [domain, setDomain] = useState(""); // hashed domain
  const [owner, setOwner] = useState<string | null>(null); // owner address
